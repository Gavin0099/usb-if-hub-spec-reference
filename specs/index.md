...
features:
  ...
  - title: Port Status Bits
    details: 整理 wPortStatus、wPortChange、wHubStatus 與 wHubChange 的 bit semantics 與 observation boundaries。
    link: /port_status_bits
  - title: Hub Descriptor
    details: 說明 USB 2.0 hub descriptor fields 與 wHubCharacteristics 的語意。
    link: /hub_descriptor
  ...
  - title: Verification Status
    details: 目前共有 47 筆 tracked entries，其中 8 筆 verified、27 筆 reviewed、12 筆 inferred，並附 non-claims 與 evidence packet 狀態。
